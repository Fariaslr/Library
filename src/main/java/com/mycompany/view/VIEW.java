...
import com.mycompany.jdbc.GeneroJDBC;
import com.mycompany.jdbc.LivroJDBC;
...
import com.mycompany.resources.CenterTabbedPane;
import com.mycompany.resources.PDFgenerator;
    ...
    private void tableMarcacoesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMarcacoesMouseClicked
        ...
        switch (escolha) {
            ...
            case 2 -> {
                ...
                geradorPDF.criadorDePdf(auxiliar.get(tableMarcacoes.getSelectedRow()));
            }
            default -> {
            }
        }
